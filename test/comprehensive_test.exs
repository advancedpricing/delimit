defmodule Delimit.ComprehensiveTest do
  ...
  describe "headers management" do
    ...
    test "writes CSV without headers" do
      data = [
        %{id: 1, name: "Test 1", value: 10.5, active: true, created_at: ~D[2023-01-01], tags: "test"},
        %{id: 2, name: "Test 2", value: 20.5, active: false, created_at: ~D[2023-01-02], tags: nil}
      ]
  ...
  describe "parsing options" do
    ...
    test "delimiter option" do
      ...
      data = [%{id: 1, name: "Test", value: 10.0, active: true, created_at: ~D[2023-01-01], tags: nil}]
  ...
  describe "streaming operations" do
    setup do
      ...
      test_file = Path.join(System.tmp_dir(), "delimit_stream_test_#{:rand.uniform(1000000)}.csv")
  ...
  describe "line ending and skipping options" do
    ...
    test "skip_while with complex condition" do
      ...
      csv_with_metadata = String.replace("""
      ...
      items = SimpleSchema.read_string(csv_with_metadata,
        skip_while: fn line -> 
    ...
    test "write with custom line_ending" do
      data = [
        %{id: 1, name: "Test", value: 10.0, active: true, created_at: ~D[2023-01-01], tags: nil}
      ]
