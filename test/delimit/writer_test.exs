defmodule Delimit.WriterTest do
  ...
  alias Delimit.TestSupport.Schemas.{
    SimpleSchema,
    FullSchema,
    CustomBoolean,
    CustomConversion
  ...
  describe "basic writing functionality" do
    ...
    test "writes CSV with headers" do
      ...
      assert String.contains?(output, "first_name,last_name,age,salary,hired_date,active,notes")
      # Data should appear
      assert String.contains?(output, "John,Doe,30,50000.5,2020-01-15,true,Good employee")
    end
  ...
  describe "writing options" do
    ...
    test "escape character option" do
      ...
      assert String.contains?(output, "\"Item \"\"quoted\"\"\",20,false")
