defmodule Delimit.Integration.FormatOptionsTest do
  ...
  describe "format inference" do
    test "infers format from file extension" do
      ...
      csv_file = String.replace(Helpers.temp_file_path(), ".csv", ".csv")
      tsv_file = String.replace(Helpers.temp_file_path(), ".csv", ".tsv")
      psv_file = String.replace(Helpers.temp_file_path(), ".csv", ".psv")
